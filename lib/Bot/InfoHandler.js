...
class InfoHandler {
    ...
    constructor(dj, handler, options) {
        ...
        this.onDataChanged = function() {
            updateNowPlaying(this.dj.nowPlaying instanceof IcyAudio);
            updateInfoMessage();
        }.bind(this);
    ...
    updateSongHistory(create) {
        ...
        if(this.songHistory.lastMessage != msg) {
            ...
            if(create) {
                ...
                if(msg != null) {
                    this.handler.sendMessage(this.songHistory.channel, msg).then(function(obj, error) {
    ...
    createInfoMessage() {
        ...
        var modeInfo = this.dj.mode.getAdditionalInfo();
        if(modeInfo != null) {
            msg += modeInfo;
        }
