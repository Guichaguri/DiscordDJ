...
module.exports = function(handler) {
    handler.registerCommand('skip', ['skip', 'skp', 'next'], skip, 1 << 22);
    handler.registerCommand('add', ['add', 'song', 'music', 'set'], add, '');
    handler.registerCommand('youtube', ['youtube', 'yt', 'video'], youtube, null);
    handler.registerCommand('soundcloud', ['soundcloud', 'sc'], soundcloud, '');
    handler.registerCommand('icy', ['icy', 'shoutcast', 'icecast', 'stream'], icy, '');
    handler.registerCommand('file', ['file', 'fs', 'mp3'], file, '');

    handler.registerCommand('raw-pm', [], pmHandler, '');
    //TODO permissions
};