...
class ChatHandler {
    ...
    createCommandHandler() {
        return function(obj, authorObj, content, server) {
            ...
            if(server == null && dj.commands['raw-pm'] != null) {
                dj.commands['raw-pm'].run(this, obj, authorObj, this.dj, args);
            }
    ...
    addRole(user, server, role) {

    }

    removeRole(user, server, role) {
...
class DiscordieChatHandler extends ChatHandler {
    ...
    addRole(user, member, role) {
        member.assignRole(role);
    }

    removeRole(user, member, role) {
