...
class DJ extends EventEmitter {
    ...
    constructor(discord, guildId, channelId) {
        ...
        this._playableInterval = null; // Playable clock

        this._audioOptions = {}; // Audio Options (TODO)
    ...
    load(p) {
        ...
        } else if(p instanceof stream.Readable) {
     ...
     */
    play() {
        //this._playableInterval = setInterval(this._processAudio.bind(this), );
        // TODO
    }
     ...
     */
    stop() {
        clearInterval(this._playableInterval);
