        ...
        https.get('https://api.soundcloud.com/resolve?url=' + encodeURIComponent(this.url) +
            ...
            https.get(loc, function(ress) {
                ...
                ress.on('end', function() {
                    ...
                    self.title = (data['label_name'] != '' ? data['label_name'] : data['user']['username']) + " - " + data['title'];
                    self.streamUrl = data['stream_url'] + "?client_id=" + encodeURIComponent(self.key);
                    self.url = data['permalink_url'];
...
//new SoundcloudAudio(null, "https://soundcloud.com/royaltyfreekings/rise-up-mp3", "e6a1e5db06c15fc90588f2a3119a5051").createStream();