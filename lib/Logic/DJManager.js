...
var createHandler = require('../Bot/ChatHandler.js');
...
class DJManager {
    ...
    create(voiceChannel, type) {
        ...
        if(this.handler == null) this.handler = createHandler(this.bot);
        ...
        return new Promise(function(resolve, reject) {
            ...
            if (this.bot == null || !this.ready) {
                ...
                voiceChannel.join(false, false).then(function(info) {
                    var dj = new type(this.bot, info.voiceConnection, this.handler);
                    this.djs.push(dj);
                    resolve(dj);
                }.bind(this), reject);
            }
    ...
    getFromUser(user) {
        ...
        if(guild != null && vc == null) return null;
        ...
        for(var i = 0; i < this.djs.length; i++) {
            ...
            if(guild != null) {
                ...
                vc = user.getVoiceChannel(dj.voiceConnection.guild);
